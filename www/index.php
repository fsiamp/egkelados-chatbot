...
Egkelados is written by Fanis Siampos
...
if (strpos($s,'KnyteTrypper') !== false) {
    $s = str_replace("KnyteTrypper","Fanis Siampos",$s);
}
...
echo $zzz;
    echo "<br><br>";
       ...
       <b>You</b>: <input autocomplete='off' id='text' type='text' name='query_string' size='17' id='query_string' class='BodyCopy' style='border: none; width:79%; font-family:monospace; font-size:15px;'  autofocus></form>
<br>";
